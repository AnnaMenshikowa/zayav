...
namespace KP_Staff
{
    ...
    public partial class NewWorkerPage : Page
    {
        ...
        public NewWorkerPage(string _log, string _pass)
        {
            InitializeComponent();
            log = _log;
            pass = _pass;
        ...
        {        
            ...
            if (c == 2)
            {
                if(reg_auth.AddUserInfo("Работник", login, password, C_name, middlename, surname, education, birth, series_p, number_p, start, email, phone, address) == true){
