...
namespace KP_Staff
{
    ...
    public partial class NewChallengerPage : Page
    {
        ...
        public NewChallengerPage(string _log, string _pass)
        {
            InitializeComponent();
            log = _log;
            pass = _pass;
        ...
        private void btnNext_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (c == 2)
            {
                if (reg_auth.AddUserInfo("Претендент", login, password, C_name, middlename, surname, education, birth, 0, 0, start, email, phone, address) == true)
                {
