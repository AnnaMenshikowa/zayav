...
namespace KP_Staff
{
    ...
    public partial class WorkerPage : Page
    {
        ...
        {
            var queryEmployee = from staff in workersEntities.Staff orderby staff.surname select staff;
        ...
        {
            System.Windows.Controls.ComboBox cmb = (System.Windows.Controls.ComboBox)sender;
            var res = from k in workersEntities.Salary
                      select k;
            cmb.ItemsSource = res.ToList();
        ...
        {
            System.Windows.Controls.ComboBox cmb = (System.Windows.Controls.ComboBox)sender;
            var res = from k in workersEntities.Premium
                      select k;
            cmb.ItemsSource = res.ToList();
        ...
        private void DeleteCommandBinding_Executed(object sender, ExecutedRoutedEventArgs e)
        {
            ...
            if (staff != null)
            {
                workersEntities.Staff.Remove(staff);
        ...
        private void ButtonFindSalary_Click(object sender, RoutedEventArgs e)
        {
            ...
            var querySalary = from s in workersEntities.Salary
                              where s.sizeofsalary >= salary
                              select s;
            foreach (Salary s in querySalary)
            {
                id = s.id_sal;
                var queryStaff = from staff in workersEntities.Staff
        ...
        private void ButtonFindSurname_Click(object sender, RoutedEventArgs e)
        {
            ...
            var queryportsmen = from staff in workersEntities.Staff
        ...
        private void btnFindAll_Click(object sender, RoutedEventArgs e)
        {
            ...
            var queryPos = from s in workersEntities.Position
                        where s.C_name.Contains(position)
                        select s;
            var queryStaff = from staff in workersEntities.Staff select staff;
            foreach (Position p in queryPos)
            {
                ...
                {
                    id1 = s.id_sal; 
                    queryStaff = from staff in workersEntities.Staff
